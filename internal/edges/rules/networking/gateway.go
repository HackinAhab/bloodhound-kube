...
func gatewayHTTPRouteEdges(ctx *framework.Context, gatewayRef *nodes.Gateway, gatewayNS string) []model.BloodHoundEdge {
	if ctx == nil || ctx.Core == nil {
		return nil
	}
...
func gatewayGRPCRouteEdges(ctx *framework.Context, gatewayRef *nodes.Gateway, gatewayNS string) []model.BloodHoundEdge {
	if ctx == nil || ctx.Core == nil {
		return nil
	}
	edges := []model.BloodHoundEdge{}
...
func gatewayTCPRouteEdges(ctx *framework.Context, gatewayRef *nodes.Gateway, gatewayNS string) []model.BloodHoundEdge {
	if ctx == nil || ctx.Core == nil {
		return nil
	}
	edges := []model.BloodHoundEdge{}
...
func gatewayTLSRouteEdges(ctx *framework.Context, gatewayRef *nodes.Gateway, gatewayNS string) []model.BloodHoundEdge {
	if ctx == nil || ctx.Core == nil {
		return nil
	}
	edges := []model.BloodHoundEdge{}
