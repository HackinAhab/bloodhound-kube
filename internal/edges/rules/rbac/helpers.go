...
func resolveNamespacedSubjectSA(ctx *framework.Context, namespace, bindingNamespace, subjectKind, subjectNamespace, subjectName string) *nodes.ServiceAccount {
...
func resolveClusterSubjectSA(ctx *framework.Context, subjectKind, subjectNamespace, subjectName string) *nodes.ServiceAccount {
